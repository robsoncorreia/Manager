...
using FC.Updater.View.Components;
using System;
...
namespace FC.Updater.ViewModel
{
    public abstract class FlexViewModelBase : ObservableRecipient
    {
        ...
        internal readonly IGatewayRepository _gatewayRepository;
        internal readonly ISettingsRepository _configurationRepository;
        ...
        internal readonly IGatewayService _gatewayService;
